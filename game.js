...
(function (t) {
    ...
    function r(t, e) {
        t = t || {}, this.isMaster = t.isMaster, this.isStandalone = t.isStandalone, this.messenger = t.messenger, this.moduleReady = e ? e : !1, this.timeoutAfter = 500, this.timeout = !1, this._callbacks = {pause: !1, resume: !1}
    }

    function o(t, e) {
        t = t || {}, this.IS_MASTER = t.isMaster, this.IS_SLAVE = !this.IS_MASTER, this.data = t.data, this.messenger = t.messenger, this.moduleReady = e ? e : !1, this.gamePlayTracking = {started: !1, appid: null, host: null, timestamp: null}, this.timeInGameTracking = {started: !1, appid: null, timestamp: null}
    }
    ...
    function u(t) {
        ...
        if ("string" == typeof t && (o = t.split("|"), "gameapi" === o[0])) {
            ...
            try {
                r = {type: e, callbackId: i, data: "" !== n ? JSON.parse(n) : ""}
            } catch (a) {
            }
        }
        return r
    ...
    function l(t, n, r, o, a) {
        this.version = "0.10.3", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({isMaster: !0}) : null, this.__.messenger = new n({isMaster: this.IS_MASTER, api: this, target: this._getTarget(), dataStore: this.__.dataStore}), this.__.components = new e, this.Branding = new r({isMaster: this.IS_MASTER, messenger: this.__.messenger, components: this.__.components}, !1), this.__.EventTracking = new o({isMaster: this.IS_MASTER, data: null, messenger: this.__.messenger}, !1), this.GameBreak = new a({isMaster: this.IS_MASTER, isStandalone: this.IS_STANDALONE, messenger: this.__.messenger}, !1), this.Game = new i({isMaster: this.IS_MASTER, messenger: this.__.messenger}, !1)
    }

    var p;
    (function (t) {
        if ("function" == typeof bootstrap)bootstrap("promise", t); else if ("object" == typeof exports)module.exports = t(); else if ("function" == typeof define && define.amd)define(t); else if ("undefined" != typeof ses) {
            if (!ses.ok())return;
            ses.makeQ = t
        } else p = t()
    })(function () {
        ...
        function i(t, e) {
            if (V && e.stack && "object" == typeof t && null !== t && t.stack && -1 === t.stack.indexOf(ne)) {
        ...
        function p() {
            ...
            var e, n = [], i = [], r = K(p.prototype), o = K(d.prototype);
        ...
        function I(t) {
            if (oe) {
                var e = z(re, t);
                -1 !== e && (re.splice(e, 1), ie.splice(e, 1))
            }
        }
        ...
        function x(t) {
            return g(t, function (t) {
                return t = Y(t, l), g(O(Y(t, function (t) {
                    return g(t, W, W)
                })), function () {
                    return t
                })
        ...
        var J, F, U = u(), W = function () {
            ...
            var e = {task: void 0, next: null}, n = e, i = !1, r = void 0, o = !1;
            if (H = function (t) {
                n = n.next = {task: t, domain: o && process.domain, next: null}, i || (i = !0, r())
            ...
            return H
        }(), X = Function.call, $ = t(Array.prototype.slice), Q = t(Array.prototype.reduce || function (t, e) {
        ...
        l.resolve = l, l.nextTick = H, l.longStackSupport = !1, l.defer = p, p.prototype.makeNodeResolver = function () {
            var t = this;
            return function (e, n) {
                e ? t.reject(e) : arguments.length > 2 ? t.resolve($(arguments, 1)) : t.resolve(n)
            }
        }, l.Promise = h, l.promise = h, h.race = f, h.all = O, h.reject = A, h.resolve = l, l.passByCopy = function (t) {
            return t
        ...
        }, l.when = g, d.prototype.thenResolve = function (t) {
        ...
        }, l.nearer = m, l.isPromise = y, l.isPromiseAlike = v, l.isPending = _, d.prototype.isPending = function () {
            return"pending" === this.inspect().state
        }, l.isFulfilled = b, d.prototype.isFulfilled = function () {
            return"fulfilled" === this.inspect().state
        }, l.isRejected = S, d.prototype.isRejected = function () {
            return"rejected" === this.inspect().state
        };
        var ie = [], re = [], oe = !0;
        l.resetUnhandledRejections = w, l.getUnhandledReasons = function () {
            return ie.slice()
        }, l.stopUnhandledRejectionTracking = function () {
            w(), oe = !1
        }, w(), l.reject = A, l.fulfill = E, l.master = M, l.spread = R, d.prototype.spread = function (t, e) {
            return this.all().then(function (e) {
                return t.apply(void 0, e)
            }, e)
        }, l.async = j, l.spawn = L, l["return"] = P, l.promised = N, l.dispatch = G, d.prototype.dispatch = function (t, e) {
            var n = this, i = p();
            return H(function () {
            ...
            return l(t).dispatch("post", [e, $(arguments, 2)])
            ...
            return O(this)
        }, l.allResolved = c(x, "allResolved", "allSettled"), d.prototype.allResolved = function () {
            return x(this)
        }, l.allSettled = C, d.prototype.allSettled = function () {
        ...
        }, l.progress = D, d.prototype.progress = function (t) {
        ...
        e || (t.Promise = p.promise, t.Promise.all = p.all, t.Promise.timeout = p.timeout, p.stopUnhandledRejectionTracking())
    }(t !== void 0 ? t : this);
    var h = {timeout: 3e3};
    h.getGameConfig = function () {
        ...
        var e = p.defer(), n = "http://api.configar.org/cf/pb/1/configs", i = t.portal.siteId, r = t.portal.channelId, o = t.portal.applicationId;
        return SpilGames(["Net", "JSLib"], function (t, a) {
            t.send({url: [n, r, i, o].join("/"), type: "GET", dataType: "JSON"}, function (t) {
                if (t && t.configar)window.postMessage(new s({type: "success", callbackId: null, data: "log.configar.getBranding.success"}), "*"), e.resolve(t.configar); else {
                    var n = {};
                    try {
    ...
    f.argsToArray = function (t) {
        ...
        return/static.egret-labs.org/.test(window.location.host)
    }, f.getRole = function () {
        var t = "function" == typeof window.SpilGames, e = window.self !== window.top, n = null;
        if (f.isA10())return{IS_MASTER: !0, IS_SLAVE: !0, IS_STANDALONE: !0};
        if (t) {
            var i = document.getElementById("#iframegame");
            switch (i) {
                case"null":
                    n = {IS_MASTER: !0, IS_SLAVE: !0, IS_STANDALONE: !1};
                    break;
                default:
                    n = {IS_MASTER: !0, IS_SLAVE: !1, IS_STANDALONE: !1}
            }
        } else n = e ? {IS_MASTER: !1, IS_SLAVE: !0, IS_STANDALONE: !1} : {IS_MASTER: !0, IS_SLAVE: !0, IS_STANDALONE: !0};
        return n
    }, f.callConfigar = function (t, e) {
        var n, i, r = t.site || 500, o = t.channel || 100, a = t.id || null;
        window.XDomainRequest ? (n = new XDomainRequest, n.onload = function () {
            e(n.status, n.responseText)
        }, n.onerror = function () {
            e(404, null)
        }, n.onprogress = function () {
        }) : window.XMLHttpRequest ? (n = new XMLHttpRequest, n.onreadystatechange = function () {
        ...
        for (var n in e)if (e.hasOwnProperty(n)) {
            if (!t.hasOwnProperty(n))return{error: "Wrong argument passed: " + n};
            if (t.hasOwnProperty(n)) {
                var i = "object" == typeof t[n] ? t[n].type : t[n];
                if (e[n].constructor.name !== i)return{error: "Wrong value type for " + n + ": expected " + t[n] + ", got " + e[n].constructor.name};
                var r = t[n] && t[n].values || [];
                if (-1 === r.indexOf(e[n]))return{error: "Wrong value for " + n + ": expected " + r.join(" or ") + ", got " + e[n]}
            }
        }
        return{error: !1}
    };
    ...
    d.getGameConfig = function () {
        ...
        var n = {}, i = {configar: {branding: {main: {label: "main", image: "", url: "http://static.egret-labs.org/h5game/gameList/game.html", style: "", width: "202", height: "50", mime: "image/png", type: "png", handler: "newTab", blacklisted: !0}, logo: {label: "logo", image: "", url: "http://static.egret-labs.org/h5game/gameList/game.html", style: "", width: "202", height: "50", mime: "image/png", type: "png", handler: "newTab", blacklisted: !1}, more_games: {label: "more_games", image: null, url: "http://static.egret-labs.org/h5game/gameList/game.html", style: "", width: null, height: null, mime: null, type: null, handler: "newTab", blacklisted: !1}, splash_screen: {label: "splash_screen", image: "place_holder_string", url: "http://static.egret-labs.org/h5game/gameList/game.html", style: "", width: "0", height: "0", mime: "image/png", type: "png", handler: "newTab", blacklisted: !1}}}};
        n.JSLib = {memory: {}, _channels: {}, get: function (t) {
            ...
            this._channels[t] || (this._channels[t] = []), this._channels[t].push({fn: e})
        }}, n.Net = {send: function (t, e) {
            e.call(this, {})
        }}, window.SpilGamesBootstrap = [], window.SpilGames = function () {
            var t = arguments;
            if (t[0] && "string" == typeof t[0])n.JSLib.publish(t[0], t[1] || null); else if (t[0] && t[0]instanceof Array) {
                var e, i, r = [];
                for (e = 0, i = t[0].length; i > e; e++)r.push(n[t[0][e]]);
                t[1].apply(this, r)
            }
        }, t && t.id ? f.callConfigar(t, function (n, r) {
            if (200 === n && "string" == typeof r && JSON.parse(r)) {
                var o = JSON.parse(r);
                e.call(this, {branding: o.configar && o.configar.branding ? o.configar.branding : i.configar.branding, portal: {applicationId: t.id, siteId: t.site ? t.site : 500, channelId: t.channel ? t.channel : 100}})
            } else e.call(this, {branding: i.configar.branding})
        }) : e.call(this, {branding: i.configar.branding})
    }, d.getCachedConfig = function () {
    }, e.prototype.newTab = function (t) {
        var e = window.navigator.userAgent.toLowerCase().match(/android.*applewebkit\/([\d.]+)/), n = e && 537 > e[1], i = n ? "_self" : "_blank", r = t.url, o = window.open(r, i);
        return o && o.focus(), o
        ...
        var e = document.createElement("div"), n = t.url, i = t.action, r = t.callback;
        return e.setAttribute("id", "spilgames-splash-screen-sample"), document.body.appendChild(e), e.style.left = "0", e.style.top = "0", e.style.width = "100%", e.style.height = "100%", e.style.position = "absolute", e.style.zIndex = "10000", e.onclick = i, n && (e.style.background = "url('" + n + "') center center no-repeat #FFF"), window.setTimeout(function () {
            var t = document.getElementById("spilgames-splash-screen-sample");
            t.parentNode.removeChild(t), r && r()
        }, 2e3), e
    }, n.prototype.get = function (t) {
        for (var e = this.dataStore, n = t.split("."), i = n.length, r = 0; i - 1 > r; r++) {
            if (!e[n[r]])return null;
            e = e[n[r]]
        }
        return e[n[i - 1]] || null
    }, n.prototype.put = function (t, e) {
        for (var n = this.dataStore, i = t.split("."), r = i.length, o = 0; r - 1 > o; o++) {
            var a = i[o];
            n[a] || (n[a] = {}), n = n[a]
        }
        n[i[r - 1]] = e
        ...
        return this.notify({type: "new", key: t, current: e, previous: null, timestamp: n}), e
    }, n.prototype.update = function (t, e) {
        var n, i, r = null;
        return this.get(t) ? (n = "update", r = this.get(t)) : n = "new", this.put(t, e), i = Date.parse(new Date), this.notify({type: n, key: t, current: e, previous: r, timestamp: i}), e
    }, n.prototype.remove = function (t) {
        if (this.get(t)) {
            var e, n = this.get(t);
            return this.put(t, null), e = Date.parse(new Date), this.notify({type: "remove", key: t, current: null, previous: n, timestamp: e}), !0
        }
        return!1
        ...
        if (this.IS_MASTER) {
            var e = new s({type: "datachange", callbackId: null, data: t}).encode();
            return window.postMessage(e, "*"), e
        }
    }, i.prototype._performAction = function (t) {
        var e = new s(t.data || {}), n = this.messenger, i = this.subscribers || {};
        if (e && e.type && e.data)switch (e.type) {
            case"gameEvent":
                e.data[0] && i[e.data[0]] && i[e.data[0]].length > 0 && i[e.data[0]].forEach(function (t) {
                    t.call(this), n._postMessage([e.data[0], {origin: "slave"}, null], null, "gameState")
                });
                break;
            case"gameState":
        ...
        this.messenger._postMessage([t, {origin: "master"}, null], null, "gameEvent")
        ...
        if (!this.moduleReady)throw Error("This method cannot be called before the API is loaded");
        this._callbacks.pause = t, this._callbacks.resume = e, this.messenger._postMessage(void 0, void 0, "game.ad.request"), this.isMaster || this.messenger._postMessage(["log.gameapi.ad.requested", {origin: "slave"}, null], null, "log"), this.timeout = setTimeout(function () {
            n._requestTimeout()
        }, this.timeoutAfter)
    }, r.prototype._onAdAccepted = function (t) {
        var e = this.messenger;
        this.timeout && clearTimeout(this.timeout), !this.isMaster && t && (e._postMessage(["log.gameapi.ad.start", {origin: "slave"}, null], null, "log"), this._runCallback("pause"))
    }, r.prototype._onAdCompleted = function () {
        var t = this.messenger;
        this.isMaster || t._postMessage(["log.gameapi.ad.complete", {origin: "slave"}, null], null, "log"), this._runCallback("resume")
    }, r.prototype._requestTimeout = function () {
        this._onAdCompleted()
    }, o.prototype.init = function (t) {
        t = t || {}, this.data = t.data || this.data;
        var e = this.data && this.data.game && this.data.game.applicationId ? this.data.game.applicationId : null, n = new Date, i = window.location.hostname;
        (this.IS_SLAVE || f.isWrapped()) && this.startInternalTracking(e, n, i)
    }, o.prototype._createEventObject = function (t, e, n) {
        return{eventCategory: t, eventAction: e, properties: n}
        ...
        var e = this.gamePlayTracking.gid, n = this.gamePlayTracking.timestamp, i = this.gamePlayTracking.host, r = this._createEventObject("game", "gameplay", {applicationId: e, start: n, host: i});
        return this._sendSETEvent("express", r, t), r
    }, o.prototype.trackTimeInGame = function (t) {
        if (!this.timeInGameTracking.started)return!1;
        var e = this.timeInGameTracking.gid, n = this.timeInGameTracking.timestamp, i = this._createEventObject("game", "heartbeat", {applicationId: e, start: n});
        return this._sendSETEvent("express", i, t), i
    }, o.prototype.startInternalTracking = function (t, e, n) {
        var i = this, r = 6e4, o = function (t) {
        ...
        return this.moduleReady ? t ? (this.gamePlayTracking.gid = t, this.gamePlayTracking.timestamp = Date.parse(e), this.gamePlayTracking.host = n, this.gamePlayTracking.started = !0, this.timeInGameTracking.gid = t, this.timeInGameTracking.timestamp = Date.parse(e), this.timeInGameTracking.started = !0, this.trackGamePlay(function (t) {
            ...
            i.trackTimeInGame(o)
        }, r), this.gamePlayTracking.started && this.timeInGameTracking.started) : {error: "No application ID defined for this game"} : {error: "This method cannot be called before the API is loaded"}
        ...
        this.messenger._postMessage(["log.branding.getlogo", {origin: e}, null], null, "log");
        var n, i, r = {type: {type: "String", values: ["png"]}, width: "Number", height: "Number"};
        ...
        if (!t)return{error: "No link identifier provided"};
        var e = this.listLinks();
        if (-1 !== e.indexOf(t)) {
            var n = this.IS_MASTER ? "master" : "slave";
            return this.messenger._postMessage(["log.branding.getlink", {origin: n, linkName: t}, null], null, "log"), this._getLink(t)
        }
        return{error: "Invalid option: '" + t + "'", action: function () {
        }}
    }, a.prototype._getLink = function (t) {
        if (!t)return{error: "No link identifier provided"};
        var e = this.data && this.data.branding ? this.data.branding : {};
        return e && e[t] ? {linkName: t, image: e[t].image || !1, action: this._executeHandler.bind(this, t)} : {error: "Invalid option: '" + t + "'", action: function () {
        }}
    }, a.prototype._getGMLink = function (t) {
        var e = null;
        if (!t)return{error: "No link identifier provided"};
        var n = this.data && this.data.branding ? this.data.branding : {};
        return n && n[t] ? (e = this._tagUrl(n[t].url, t), {linkName: t, url: e}) : {error: "Invalid option: '" + t + "'", url: null}
    }, a.prototype.getLinks = function () {
        var t = {}, e = this.listLinks();
        if (0 === e.length)t = {more_games: {action: function () {
        ...
        var e = this.data && this.data.branding ? this.data.branding : {}, n = e[t], i = n.handler, r = this._tagUrl(n.url, t);
        if (n.url && n.url.length > 0 && i && this.components[i]) {
            var o = this.IS_MASTER ? "master" : "slave";
            return this.messenger._postMessage(["log.branding.linkAction", {origin: o, linkName: t}, null], null, "log"), this.components[i]({url: r})
        }
        return function () {
        }
    }, a.prototype.listLinks = function () {
        var t = [], e = this.data && this.data.branding ? this.data.branding : {}, n = Object.keys(e);
        ...
        if (this.data && this.data.branding && this.data.branding.splash_screen) {
            var n = !0;
            this.data.branding.splash_screen.image || this.data.branding.splash_screen.url || (n = !1), t = {show: n, action: this._getLink("splash_screen").action || function () {
            }}
        } else t = {show: !0, action: function () {
        }};
        return this.messenger._postMessage(["log.branding.splashScreen", {origin: e}, null], null, "log"), t
        ...
        var e = this.IS_MASTER ? "master" : "slave", n = this._getLink("logo").image;
        n && this.getSplashScreen().show ? ("master" !== e && this.messenger._postMessage(["log.branding.displaySplashScreen", {origin: e}, null], null, "log"), this.components.displayOnTop({url: n, action: this.getSplashScreen().action, callback: t})) : t()
    }, a.prototype._tagUrl = function (t, e) {
        var n, i, r, o = this.data && this.data.portal ? this.data.portal : {}, a = this.data && this.data.game ? this.data.game : {}, s = parseInt(o.siteId, 10);
        ...
        var e, n, i, r, o = this, a = new s(t.data);
        if (a)if (e = a.type, n = a.callbackId, i = a.data, r = this._callbacks[n] || !1, this.IS_MASTER)switch (e) {
            ...
            default:
                this.publish(e, i)
        } else this.IS_SLAVE && ("function" == typeof r ? (delete this._callbacks[n], r(i)) : "datachange" === e || "jslib" !== e && this.publish(e, i));
        return!1
    }, c.prototype._handleUGARequest = function (t) {
        var e, n, i, r = this, o = new s(t.data);
        if (o)switch (e = o.data[0], n = o.callbackId, i = o.data[1] ? o.data[1] : null, e) {
            ...
            case"GameAPI.isReady":
                r._postMessage({isready: this.api.isReady}, n, "ugapi")
        }
        ...
        if ("function" != typeof e)throw Error("Callback has to be a function");
        if ("string" != typeof t)throw Error("Channel name has to be a string");
        return this._channels[t] || (this._channels[t] = []), this._channels[t].push({fn: e, ctx: n}), this
        ...
        var t = document.getElementById("iframegame"), e = t && t.contentWindow ? t.contentWindow : window.parent;
        return this.IS_MASTER ? e : window.parent
    }, l.prototype.loadAPI = function (t, e) {
        function n(e) {
            return a.IS_MASTER && (e = i(e)), a.isReady = !0, a.Branding.moduleReady = !0, a.__.EventTracking.moduleReady = !0, a.GameBreak.moduleReady = !0, a.Game.moduleReady = !0, a.Branding.init({data: e}), a.__.EventTracking.init({data: e}), a.GameBreak.init(), a.__.messenger._postMessage(["log.gameapi.loadapi.finish", {origin: s, version: a.version}, null], null, "log"), t(a)
        }

        function i(t) {
            var e = t.game || {}, n = t.user || {}, i = t.portal || {}, r = t.branding || {};
            return d.getLocalConfig({game: e, user: n, portal: i, branding: r})
        }
        ...
        function o() {
            a.__.messenger.requestFromParent("GameAPI.isReady", {}, function (t) {
                t.isready ? r() : 5 > u ? (u++, setTimeout(o, 500)) : r()
            })
        }

        var a = this, s = this.IS_MASTER ? "master" : "slave", u = 0;
        if ("function" != typeof t)throw Error("argument passed to loadAPI method should be a function");
        return!0 === this.isReady ? (window.console && window.console.log && console.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), t(a)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {origin: s, version: a.version}, null], null, "log"), this.IS_STANDALONE ? (e = e || null, d.setupStandaloneMode(e, function (t) {
            a.__.dataStore._setCache(i(t)), n(t)
        })) : this.IS_MASTER ? d.getGameConfig().then(function (t) {
            d.getBrandingConfig(t).then(function (e) {
                t && !t.isError && (t.branding = e.branding, a.__.dataStore._setCache(i(t))), n(t)
            })
        }) : o(), void 0)
    };
    var g = new l(n, c, a, o, r);
